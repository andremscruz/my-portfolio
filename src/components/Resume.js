    ...
    return(
        <div className="resume-div">
            <div className="resume-profile-text">
                <CgProfile style={{ fontSize: '25px', marginBottom: '15px' }}/>
            ...
            <div className="resume-grid">
                <div className="resume-column1">
                    ...
                    <div className="profile-skills">
                        ...
                        <p style={{ marginBottom: '25px' }}>Java • JavaScript • C# • HTML • CSS • MySQL • NoSQL</p>

                        <h3 className="resume-p">Soft Skills:</h3>
                        <p style={{ marginBottom: '25px' }}>Problem Solving • Critical Thinking • Communication • Decision Making • Self-Motivation</p>

                        <h3 className="resume-p">Languages:</h3>
                        <p style={{ marginBottom: '25px' }}>Portuguese (C2) • English (C1)</p>
                    </div>
                </div>
                <div className="resume-column2">
                    <div className="profile-education">
                        ...
                        <span>January 2020 - April 2021</span>
                    </div>
